...
class GCNModel():
    ...
    def __init__(self, placeholders, num_features, emb_dim, features_nonzero, adj_nonzero, num_r, name, act=tf.nn.selu):
        self.name = name
    ...
    def build(self):
        ...
        self.embeddings = self.hidden1 * \
                          self.att[0] + self.hidden2 * self.att[1] + self.att[2] * self.emb
