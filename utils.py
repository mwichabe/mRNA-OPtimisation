...
def constructHNet(miR_tar_matrix, miR_matrix, tar_matrix):
    ...
    assert miR_matrix.shape[0] == miR_tar_matrix.shape[0]  # Rows of miR_matrix match rows of miR_tar_matrix
    assert tar_matrix.shape[1] == miR_tar_matrix.shape[1]  # Columns of tar_matrix match columns of miR_tar_matrix
